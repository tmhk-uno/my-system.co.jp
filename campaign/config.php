...
if($_SERVER["HTTP_HOST"] == "bizzone.xsrv.jp") {
    $recaptcha_client = "6Ld-1rwlAAAAALHaq51KLOCjoFCSSTVqKAOfcpnR";
    $recaptcha_server = "6Ld-1rwlAAAAAP9xDEXT4WMT1cEEyEq8iYgXdozX";
}
else {
...
function F_COOKIE_N($val) { return (isset($_COOKIE[$val])) ? $_COOKIE[$val] : ""; }
function S_COOKIE_N($val1, $val2, $val3, $val4) { setcookie($val1, ($val2 == "") ? "" : $val2, $val3, $val4); }
