							...
							<li>
								...
								<div class="cnt">
									<select name="question2" id="question2" title="question2" class="sel_opt1 type1">
										<option value="">選択してください</option>
                                        <option value="KITENE" <?php if($outputData['question2'] == 'KITENE') { echo('selected="selected"'); }?>>KITENE（店舗アプリ・キテネ）</option>
                                        <option value="TurnedK" <?php if($outputData['question2'] == 'TurnedK') { echo('selected="selected"'); }?>>TurnedK（光触媒空気清浄機ターンドケイ）</option>
